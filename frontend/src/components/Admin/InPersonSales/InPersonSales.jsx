        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block text-zinc-300">Email do Cliente</label>
                <input
                  type="email"
                  ...
                  className={inputCls}
                />
                {searchingCustomer && <p className="text-[11px] text-zinc-500 mt-1">Buscando cliente...</p>}
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                <label className="text-sm font-medium mb-2 block text-zinc-300">Observacoes</label>
                <input
                  type="text"
                ...
                {recentSales.map((s) => (
                  <div key={s.id_pedido} className="bg-zinc-800 p-3 rounded-lg border border-zinc-700">
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="text-sm font-bold text-white">{s.nome_cliente || s.usuario?.nome || 'Cliente'}</p>
