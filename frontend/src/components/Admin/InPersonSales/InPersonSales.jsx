...
export default function InPersonSales() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setSuccess(false);
        setForm({ nome_cliente: '', cliente_email: '', metodo_pagamento: 'pix', data_pedido: new Date().toISOString().slice(0, 16), observacoes_internas: '' });
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block text-zinc-300">Email do Cliente (opcional)</label>
                <input
                  type="email"
