...
export default function Sidebar({ activeTab, setActiveTab, mobile = false, onClose = () => {} }) {
        ...
        <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen overflow-y-auto">
          <div className="p-4 flex items-center justify-between border-b border-gray-100">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-black tracking-tighter uppercase">Surface</h1>
            </div>
          ...
          <div className="mt-auto p-6 border-t border-gray-50">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-bold">Admin Surface</p>
                <p className="text-[10px] text-gray-400">admin@surface.co</p>
              </div>
            </div>
          </div>
        </aside>
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col fixed h-screen z-10 overflow-y-auto">
      {/* LOGO */}
      <div className="p-8">
        <div className="flex items-center gap-2 mb-8">
          ...
          <h1 className="text-lg font-black tracking-tighter uppercase">Surface Admin</h1>
        </div>
